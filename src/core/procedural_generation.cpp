...
void ProceduralGeneration::UpdateProbabilities(size_t level) {
  ...
  enemy_power_probability_[3] = .7 * std::max(static_cast<int>(level) - 5, 0);
  enemy_power_probability_[4] = 1 * std::max(static_cast<int>(level) - 9, 0);
  enemy_power_probability_[5] = 1.5 * std::max(static_cast<int>(level) - 13, 0);
  enemy_power_probability_[6] = 2 * std::max(static_cast<int>(level) - 17, 0);
  enemy_power_probability_[7] = 1.5 * std::max(static_cast<int>(level) - 18, 0);
  ...
  heal_amount_probability_[3] = .7 * std::max(static_cast<int>(level) - 5, 0);
  heal_amount_probability_[4] = 1 * std::max(static_cast<int>(level) - 9, 0);
  heal_amount_probability_[5] = 1.5 * std::max(static_cast<int>(level) - 13, 0);
  ...
  coin_amount_probability_[3] = .7 * std::max(static_cast<int>(level) - 5, 0);
  coin_amount_probability_[4] = 1 * std::max(static_cast<int>(level) - 9, 0);
  coin_amount_probability_[5] = 1.5 * std::max(static_cast<int>(level) - 13, 0);
  //Melee weapon power probability
  melee_weapon_power_probability_[1] = 1 + .5 * level;
  melee_weapon_power_probability_[2] = .7 * std::max(static_cast<int>(level) - 5, 0);
  melee_weapon_power_probability_[3] = 1.5 * std::max(static_cast<int>(level) - 13, 0);
  melee_weapon_power_probability_[4] = 2 * std::max(static_cast<int>(level) - 17, 0);
  //Ranged weapon power probability
  ranged_weapon_power_probability_[2] = 1 + .5 * level;
  ranged_weapon_power_probability_[3] = .5 * std::max(static_cast<int>(level) - 1, 0);
  ranged_weapon_power_probability_[4] = 1 * std::max(static_cast<int>(level) - 9, 0);
  ranged_weapon_power_probability_[5] = 1.5 * std::max(static_cast<int>(level) - 13, 0);
  ranged_weapon_power_probability_[6] = 2 * std::max(static_cast<int>(level) - 17, 0);
  return;
}
