...
void ProceduralGeneration::UpdateProbabilities(size_t level) {
  ...
  enemy_power_probability_[2] = 1 * std::max(static_cast<int>(level) - 1, 0);
  enemy_power_probability_[3] = 2 * std::max(static_cast<int>(level) - 5, 0);
  enemy_power_probability_[4] = 3 * std::max(static_cast<int>(level) - 9, 0);
  enemy_power_probability_[5] = 4 * std::max(static_cast<int>(level) - 13, 0);
  enemy_power_probability_[6] = 5 * std::max(static_cast<int>(level) - 17, 0);
  enemy_power_probability_[7] = 6 * std::max(static_cast<int>(level) - 18, 0);
  //Heal amount probability
  heal_amount_probability_[1] = 1 + .5 * level;
  heal_amount_probability_[2] = 2 * std::max(static_cast<int>(level) - 1, 0);
  heal_amount_probability_[3] = 4 * std::max(static_cast<int>(level) - 5, 0);
  heal_amount_probability_[4] = 8 * std::max(static_cast<int>(level) - 9, 0);
  heal_amount_probability_[5] = 16 * std::max(static_cast<int>(level) - 13, 0);
  //Coin amount probability
  coin_amount_probability_[1] = 1 + .5 * level;
  coin_amount_probability_[2] = 2 * std::max(static_cast<int>(level) - 1, 0);
  coin_amount_probability_[3] = 4 * std::max(static_cast<int>(level) - 5, 0);
  coin_amount_probability_[4] = 8 * std::max(static_cast<int>(level) - 9, 0);
  coin_amount_probability_[5] = 32 * std::max(static_cast<int>(level) - 13, 0);
  //Melee weapon power probability
  melee_weapon_power_probability_[1] = 1 + .5 * level;
  melee_weapon_power_probability_[2] = 2 * std::max(static_cast<int>(level) - 1, 0);
  melee_weapon_power_probability_[3] = 8 * std::max(static_cast<int>(level) - 9, 0);
  melee_weapon_power_probability_[4] = 32 * std::max(static_cast<int>(level) - 17, 0);
  //Ranged weapon power probability
  ranged_weapon_power_probability_[2] = 1 + .5 * level;
  ranged_weapon_power_probability_[3] = 2 * std::max(static_cast<int>(level) - 5, 0);
  ranged_weapon_power_probability_[4] = 8 * std::max(static_cast<int>(level) - 13, 0);
  ranged_weapon_power_probability_[5] = 16 * std::max(static_cast<int>(level) - 17, 0);
  ranged_weapon_power_probability_[6] = 20 * std::max(static_cast<int>(level) - 18, 0);
  return;
}
